...
void tablero::piezaMovida(QPoint oldCoord, QPoint newCoord)
{
    ...
    {
        matrizPiezas[coord_rey_negro.x()][coord_rey_negro.y()]->setJaque(check(matrizPiezas, coord_rey_negro, NEGRA, &arreglo_jaque_negras));
    ...
    {
        matrizPiezas[coord_rey_blanco.x()][coord_rey_blanco.y()]->setJaque(check(matrizPiezas, coord_rey_blanco, BLANCA, &arreglo_jaque_blancas));
